...
def preProcessing(self, name):
    ...
    if name in ['MH power accel rimo left', 'MH power accel rimo right']:
        ...
        lookupFilePath = '/home/mvb/0_ETH/01_MasterThesis/kartsim/src/data_vizualization_before20190401/gokart_data_preprocessing/lookup_cur_vel_to_acc.pkl'   #lookupTable file
    ...
    if name == 'MH AB':
        ...
        staticBrakeFunctionFilePath = '/home/mvb/0_ETH/01_MasterThesis/kartsim/src/data_vizualization_before20190401/gokart_data_preprocessing/staticBrakeFunction.pkl'   #static brake function file
        try:
