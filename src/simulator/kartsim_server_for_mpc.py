...
def main():
    ...
    try:
        ...
        # vehicle_model_type = 'mlp'
        # vehicle_model_name = '2x32_tanh_reg0p0001_nomodel_directinput'
        # vehicle_model_name = '3x64_softplus_reg0p001_kin_directinput_sym'
        # vehicle_model_name = '2x32_softplus_reg0p0_kin_directinput_sym'
        # vehicle_model_name = '2x32_softplus_reg0p005_kin_directinput_sym'
        # vehicle_model_name = '4x32_softplus_reg0p0001_kin_directinput_sym'
    ...
    if vehicle_model_type == 'mpc_dynamic':
        ...
        vehicle_model = DataDrivenVehicleModel(model_type='hybrid_kinematic_mlp', model_name=vehicle_model_name, direct_input=True)
