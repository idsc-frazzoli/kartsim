...
def compute_additional_data(filtered_data, name):
    ...
    if name in ['pose x [m]', 'pose y [m]']:
        ...
        lookupFilePath = '/home/mvb/0_ETH/01_MasterThesis/kartsim/src/data_visualization/lookupfunctions/lookup_cur_vel_to_acc.pkl'  # lookupTable file
        try:
        ...
        staticBrakeFunctionFilePath = '/home/mvb/0_ETH/01_MasterThesis/kartsim/src/data_visualization/lookupfunctions/staticBrakeFunction.pkl'  # static brake function file
        try:
