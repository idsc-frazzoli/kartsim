...
from learned_model.preprocessing.get_sequential_disturbance import get_sequential_disturbance
...
def main():
    ...
    if sample_data:
        print('Sampling Data...')
        path_sampled_data = sample_from_logdata(sampling_time_period, root_path_sampled_data, path_preprocessed_dataset,
                                                dataset_tag)

    if preprocess_data:
        print('Get sequential disturbance data...')
        get_sequential_disturbance(path_sampled_data, save_path_sequential_data, load_tag=load_data_set_tag,
                                   sequence_length=5, tag=dataset_tag)
