...
accRearAxle = 1     #acceleration at rear axle
tv = 0.8              #specific force difference at rear tires
...
#        p1.addItem(arrow2)
    ...
    p11.clear()
    p11.plot(x,y, pen=(255,255,255), name="Red curve")
    
    p2.clear()
    p2.plot(simTime[:,0],theta, pen=(255,255,255), name="Red curve")
    
    p3.clear()
    p3.plot(simTime[:,0],vx, pen=(255,255,255), name="Red curve")
    
    p4.clear()
    p4.plot(simTime[:,0],vy, pen=(255,255,255), name="Red curve")
    
    p5.clear()
    p5.plot(simTime[:,0],vrot, pen=(255,255,255), name="Red curve")
