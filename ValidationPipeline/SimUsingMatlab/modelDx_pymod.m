...
%     Ic = param(7);
    ...
    % Data conversion because Python doesn't like it
    B1 = double(cell2mat(param(1)));
    C1 = double(cell2mat(param(2)));
    D1 = double(cell2mat(param(3)));
    B2 = double(cell2mat(param(4)));
    C2 = double(cell2mat(param(5)));
    D2 = double(cell2mat(param(6)));
    Ic = double(cell2mat(param(7)));
    VELX = double(VELX);
    VELY = double(VELY);
    VELROTZ = double(VELROTZ);
    BETA = double(BETA);
    AB = double(AB);
    TV = double(TV);
    ...
    vel1 = mtimes(rotmat(BETA),[VELX;VELY+l1*VELROTZ]);
