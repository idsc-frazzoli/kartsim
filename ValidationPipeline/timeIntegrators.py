...
#    [accX,accY,accRot] = eng.modelDx_pymod(vx,vy,vrot,beta,accRearAxle,tv, param, nargout=3)  #Matlab function
    [accX,accY,accRot] = pymodelDx(vx,vy,vrot,beta,accRearAxle,tv, param)
